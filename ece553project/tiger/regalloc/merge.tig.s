...
move $s4, $a2
addi $s0, $zero, 0
beq $s5, $s0, Label18470
Label18471:
addi $s0, $zero, 0
beq $s4, $s0, Label18467
Label18468:
addi $s1, $zero, 4
addi $s0, $zero, 0
mul $s0, $s1, $s0 
...
move $s1, $a1
addi $s0, $zero, 0
ble $s1, $s0, Label18491
Label18492:
addi $s0, $zero, 0
bgt $s1, $s0, Label18488
Label18489:
la $s0, Label18422
move $a0, $s0
jal tig_print
