left, _)) :: rest671)) => let
 val  result = MlyValue.ntVOID (fn _ => ( let val  tydec1 = tydec1 ()
 val  restdecty1 = restdecty1 ()
 in ()
end; ()))
 in ( LrTable.NT 7, ( result, tydec1left, restdecty1right), rest671)
...
|  ( 48, ( ( _, ( MlyValue.ntVOID restdecfun1, _, restdecfun1right))
 :: ( _, ( MlyValue.ntVOID fundec1, fundec1left, _)) :: rest671)) =>
 let val  result = MlyValue.ntVOID (fn _ => ( let val  fundec1 = 
fundec1 ()
 val  restdecfun1 = restdecfun1 ()
 in ()
end; ()))
 in ( LrTable.NT 7, ( result, fundec1left, restdecfun1right), rest671)
...
|  ( 51, ( ( _, ( MlyValue.ntVOID restdecty1, _, restdecty1right)) :: 
( _, ( MlyValue.ntVOID tydec1, tydec1left, _)) :: rest671)) => let
 val  result = MlyValue.ntVOID (fn _ => ( let val  tydec1 = tydec1 ()
 val  restdecty1 = restdecty1 ()
 in ()
end; ()))
 in ( LrTable.NT 17, ( result, tydec1left, restdecty1right), rest671)

end
|  ( 52, ( rest671)) => let val  result = MlyValue.ntVOID (fn _ => ())
 in ( LrTable.NT 17, ( result, defaultPos, defaultPos), rest671)
end
|  ( 53, ( ( _, ( MlyValue.ntVOID decs1, _, decs1right)) :: ( _, ( 
MlyValue.ntVOID vardec1, vardec1left, _)) :: rest671)) => let val  
result = MlyValue.ntVOID (fn _ => ( let val  vardec1 = vardec1 ()
 val  decs1 = decs1 ()
 in ()
...
|  ( 54, ( ( _, ( MlyValue.ntVOID restdecfun1, _, restdecfun1right))
 :: ( _, ( MlyValue.ntVOID fundec1, fundec1left, _)) :: rest671)) =>
 let val  result = MlyValue.ntVOID (fn _ => ( let val  fundec1 = 
fundec1 ()
 val  restdecfun1 = restdecfun1 ()
 ...
 in ( LrTable.NT 16, ( result, fundec1left, restdecfun1right), rest671
)
end
|  ( 55, ( rest671)) => let val  result = MlyValue.ntVOID (fn _ => ())
 in ( LrTable.NT 16, ( result, defaultPos, defaultPos), rest671)
end
|  ( 56, ( ( _, ( MlyValue.ntVOID type1, _, type1right)) :: _ :: ( _, 
( MlyValue.ID ID1, _, _)) :: ( _, ( _, TYPE1left, _)) :: rest671)) =>
 let val  result = MlyValue.ntVOID (fn _ => ( let val  ID1 = ID1 ()
 val  type1 = type1 ()
 in ()
end; ()))
 in ( LrTable.NT 12, ( result, TYPE1left, type1right), rest671)
end
|  ( 57, ( ( _, ( MlyValue.ntVOID tydec1, _, tydec1right)) :: ( _, ( 
MlyValue.ntVOID type1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, _, _))
...
MlyValue.ntVOID (fn _ => ( let val  ID1 = ID1 ()
 ...
 in ( LrTable.NT 12, ( result, TYPE1left, tydec1right), rest671)
end
...
|  ( 60, ( ( _, ( MlyValue.ntVOID fundec1, _, fundec1right)) :: ( _, (
...
FUNCTION1left, _)) :: rest671)) => let val  result = MlyValue.ntVOID
 ...
 in ( LrTable.NT 11, ( result, FUNCTION1left, fundec1right), rest671)

end
|  ( 61, ( ( _, ( MlyValue.ntVOID fundec1, _, fundec1right)) :: ( _, (
...
|  ( 62, ( ( _, ( MlyValue.ntVOID exp1, exp1left, exp1right)) :: 
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  
exp1 = exp1 ()
 in ()
end; ()))
...
|  ( 63, ( ( _, ( MlyValue.ntVOID funcsarg1, _, funcsarg1right)) :: _
 :: ( _, ( MlyValue.ntVOID exp1, exp1left, _)) :: rest671)) => let
 val  result = MlyValue.ntVOID (fn _ => ( let val  exp1 = exp1 ()
 val  funcsarg1 = funcsarg1 ()
 in ()
end; ()))
 in ( LrTable.NT 9, ( result, exp1left, funcsarg1right), rest671)
end
